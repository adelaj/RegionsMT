...
$(call foreachl,1,var_base,GATHER_DIR GATHER_DIST_DIR GATHER_FILE GATHER_INC,,.)

$(call gather_mkdir,$(GATHER_DIR))
$(call gather_rm_r,$(GATHER_DIST_DIR:%=clean$(LP)%$(RP)))
...
.PHONY: distclean
distclean: | $(GATHER_DIST_DIR:%=clean$(LP)%$(RP));
