...
$(call var_reg,-std=c11 -Wall -mavx,$$1,CFLAGS:%,gcc gcc-% gcc@mingw clang clang-%,%:%)
$(call var_reg,-m32,$$1,CFLAGS LDFLAGS,%,gcc gcc-% gcc@mingw clang clang-%,i386 i686,%)
$(call var_reg,-m64,$$1,CFLAGS LDFLAGS,%,gcc gcc-% gcc@mingw clang clang-%,x86_64:%)
$(call var_reg,-O3 -flto,$$1,CFLAGS LDFLAGS,%,gcc gcc-% gcc@mingw clang clang-%,%:Release)
$(call var_reg,-D_DEBUG -g,$$1,CFLAGS:%,gcc gcc-% gcc@mingw clang clang-%,%:Debug)
...
$(call var_reg,-mavx,$$1,LDFLAGS:%,gcc gcc-% gcc@mingw clang clang-%,%:%)
$(call var_reg,-fuse-ld=gold,$$1,LDFLAGS:%,clang clang-%,%:Release)

# '__USE_MINGW_ANSI_STDIO' fixes bug with 'long double' under MinGW
$(call var_reg,-D_UCRT -D__MSVCRT_VERSION__=0x1400 -D_UNICODE -D__USE_MINGW_ANSI_STDIO,$$1,CFLAGS:%:gcc@mingw:%:%)
