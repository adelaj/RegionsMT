tcn = $(firstword $(subst @, ,$1))
tcv = $(addprefix -,$(call __tcv,$(subst -, ,$(call tcn,$1))))
...
$(call var_reg,-fuse-linker-plugin,$$1,CFLAGS LDFLAGS,%,$(filter-out %@macos,$(filter gcc%,$(CC_TOOLCHAIN))),%:Release)
...
$(call var_reg,-fuse-ld=lld,$$1,LDFLAGS:%,$(filter-out %@macos,$(filter clang%,$(CC_TOOLCHAIN))),%:%)

# '__USE_MINGW_ANSI_STDIO' fixes bug with 'long double' under MinGW
$(call var_reg,-D_UCRT -D__MSVCRT_VERSION__=0x1400 -D_UNICODE -D__USE_MINGW_ANSI_STDIO,$$1,CFLAGS:%,$(filter %@mingw,$(CC_TOOLCHAIN)),%:%)
...
$(call var_reg,-Wl$$$$(COMMA)--large-address-aware,$$1,LDFLAGS:%,$(filter %@mingw,$(CC_TOOLCHAIN)),i386 i686,%)
