...
$(call var_reg,-std=c11 -Wall -mavx,$$1,CFLAGS:%,gcc gcc-% clang clang-%,%:%)
$(call var_reg,-m32,$$1,CFLAGS LDFLAGS,%,gcc gcc-% clang clang-%,i386 i686,%)
$(call var_reg,-m64,$$1,CFLAGS LDFLAGS,%,gcc gcc-% clang clang-%,x86_64:%)
$(call var_reg,-O3 -flto,$$1,CFLAGS LDFLAGS,%,gcc gcc-% clang clang-%,%:Release)
$(call var_reg,-D_DEBUG -g,$$1,CFLAGS:%,gcc gcc-% clang clang-%,%:Debug)
$(call var_reg,-fuse-linker-plugin,$$1,CFLAGS LDFLAGS,%,gcc gcc-%,%:Release)
$(call var_reg,-Og,$$1,CFLAGS LDFLAGS,%,gcc gcc-%,%:Debug)
