...
$(call var_reg,-m64,$$1,CFLAGS LDFLAGS,%,gcc gcc-% gcc@mingw clang clang-% clang@mingw,x86_64:%)
$(call var_reg,-O3 -flto -fsanitize=undefined,$$1,CFLAGS LDFLAGS,%,gcc gcc-% gcc@mingw clang clang-% clang@mingw,%:Release)
