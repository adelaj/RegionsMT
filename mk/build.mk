...
# Caution! Rules for '$(2134)/mk/%.mk' are implicitly generated by 'gather'
define cc =
...
$(CC_OBJ): $(EP2134)/obj/%.o: $(SRC:$1)/% $(CC_CREQ) | $(EP2134)/mk/%.mk
    $$(strip $(call fetch_var,CC $(TOOLCHAIN:$2)) -MMD -MP -MF$(P2134)/mk/$$*.mk $(call fetch_var,CFLAGS $(R1234)) $(addprefix -I,$(CC_CREQ:.log=)) -o $$@ -c $$<)
all($$1): $(EP2134)/$(CC_EXE)
