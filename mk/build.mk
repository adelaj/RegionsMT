...
P2134 = $(PREFIX)/$2/$1/$3/$4
EP213 := $$(PREFIX)/$$2/$$1/$$3
EP2134 := $(EP213)/$$4

cc = $(strip $(call vect,1 2 3 4,$1,$2,$3,$4,cc_base))
define cc_base =
$(if $(call is_cc,$2,$3,$4),$(P2134)/$1
$(call var_base,$(patsubst $(PREFIX)/$1/src/%,$(P2134)/mk/%.mk,$(call rwildcard,$(PREFIX)/$1/src/,*.c)),,CC_DEP:$1:$2:$3:$4)
$(call var_base,$(patsubst $(P2134)/mk/%.mk,$(P2134)/obj/%.o,$(CC_DEP:$1:$2:$3:$4)),,CC_OBJ:$1:$2:$3:$4)
$(call vect,1,$(P2134)/$1 $(CC_DEP:$1:$2:$3:$4) $(CC_OBJ:$1:$2:$3:$4),,gather)
$(if $(filter 1,$(CLEAN_GROUP)),$(call vect,1,$(P2134)/$1 $(CC_DEP:$1:$2:$3:$4) $(CC_OBJ:$1:$2:$3:$4),remove_file,clean))
$(call var_base,$(CC_DEP:$1:$2:$3:$4),$$1,INCLUDE)
$(eval
$(EP2134)/$$1: $$(CC_OBJ:$$1:$$2:$$3:$$4) $$(call fetch_var2,LDREQ $$1 $$(TOOLCHAIN:$$2) $$3 $$4,. $$1 $$2 $$3 $$4)
    $$(strip $(call fetch_var,LD $(TOOLCHAIN:$2)) $(call fetch_var,LDFLAGS $1 $(TOOLCHAIN:$2) $3 $4) -o $$@ $$^)

$(EP2134)/obj/%.o: $$(PREFIX)/$$1/src/% $(EP2134)/mk/%.mk $$(call fetch_var2,CREQ $$1 $$(TOOLCHAIN:$$2) $$3 $$4,. $$1 $$2 $$3 $$4)
...
$(EP213).log: $$(PREFIX)/$$1/CMakeLists.txt
    ...
    -D CMAKE_EXE_LINKER_FLAGS_RELEASE="$(call fetch_var,LDFLAGS $1 $(TOOLCHAIN:$2) $3 Release)" \
    -D CMAKE_EXE_LINKER_FLAGS_DEBUG="$(call fetch_var,LDFLAGS $1 $(TOOLCHAIN:$2) $3 Debug)" \
